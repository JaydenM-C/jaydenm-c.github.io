...
% ---------- Typography ----------
\usepackage{fontspec}
% lmodern before microtype: microtype loads CM Roman protrusion tables at
% every used size, and stock CM only ships 10/11/12pt. lmodern provides a
% scalable Latin Modern substitute, silencing the "size substituted" warnings
% at our 10.5pt body size. Latin Modern is only used as a fallback; our main
% fonts remain Inter / Literata / Fira Code.
\usepackage{lmodern}
...
\par\vspace{0.3em}
\noindent\textbf{Research automation.}\ Design of agentic LLM pipelines for large-scale extraction of linguistic data from published grammars. Agents consult structured knowledge bases, iteratively draft, self-critique and  refine their output, and record grammar-specific idiosyncrasies for later use.
\par\vspace{0.3em}
\noindent\textbf{Data visualisation.}\ ggplot2, ggmap, ggtree. Interactive apps and mapping (Shiny, leaflet).\par\vspace{0.3em}
\noindent\textbf{Open science.}\ Git (\url{https://github.com/JaydenM-C}), Zenodo/OSF (e.g. \url{https://zenodo.org/records/7257104}). Reproducibility tools (renv, Docker).
\par\vspace{0.3em}
...
\item \href{https://github.com/JaydenM-C/chromatography}{\texttt{JaydenM-C/chromatography}}.\ Codebase for Chromatography (\url{https://chromatography.pages.dev/}). A web-based desktop app for crafting colour palettes from photographs.
...
\cventry{Dec 2022–Aug 2025}{%
  \textbf{Lecturer in Linguistics}\ \textcolor{inkmuted}{tenure equivalent}\\
...
\begin{cvbib}
\item \pubyear{}\quad \textbf{Macklin-Cordes, Jayden L.}\ Revisions pending.\ Trees beyond words: phonotactics in linguistic phylogenetics. \venue{Diachronica}%
\item \pubyear{}\quad \textbf{Macklin-Cordes, Jayden L.}, Maria Copot, Mitch Browne \& Tom Ennever.\ Revisions pending.\ Signal separation: Quantifying inheritance and contact in language evolution. \venue{Journal of Language Evolution}%
...
\begin{cvbib}
\item \textbf{Macklin-Cordes, Jayden L.}, Marc Allassonnière-Tang \& One-Soon Her. Ancestral state reconstruction of numeral base and classifier word orders in proto-Tibeto-Burman.\item Copot, Maria \& \textbf{Jayden L. Macklin-Cordes}. Neither rules nor exemplars: morphological representation as adaptive clustering.\end{cvbib}
...
\begin{itemize}
\item Personal blog on my linguistic research (\url{https://www.macklin-cordes.com})
...
\item Developed \textit{AusErdle}, an Australian English phonemic version of the popular \textit{Wordle} word game (\url{https://jaydenm-c.github.io/AusErdle/})
\item Wrote associated \textit{AusErdle} blog post (\url{https://jaydenm-c.github.io/posts/2022/02/auserdle/})
...
English (native); Italian (conversational); French (basic); Romanian (basic); Spanish (beginner); German (beginner).

% =============================================================================
% REFEREES
% =============================================================================
\section*{Referees}
\noindent\textit{Referees available on request.}
